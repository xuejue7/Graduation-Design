        ...
        <a-layout style="padding-top: 65px;">
          ...
          >
            <a-menu :theme="theme"
                    ...
                    mode="inline">
              <a-menu-item
                  v-if="!menuItem.children && !menuItem.is_inner && menuItem.node != '#'"
                  :key="menuItem.id"
              ...
              <a-sub-menu
                  v-if="menuItem.children && !menuItem.is_inner"
                  :key="menuItem.id.toString()"
              >
                                <span slot="title">
                                     <a-icon :type="menuItem.icon"/>
                ...
                <template v-for="(secMenu,index) in menuItem.children">
                  <a-menu-item
          ...
          <a-layout
            ...
            <a-footer style="text-align: center">
              <template>
                <span @click="footerClick">Copyright © 2026 星云网盘系统</span>
              </template>
            </a-footer>
          </a-layout>
        </a-layout>
...
export default {
  ...
  computed: {
    ...
    layoutClass() {
      ...
      if (this.$route.meta && this.$route.meta.info && !this.$route.meta.info.show_slider) {
        className += ' hide';
      }
      return className;
    }
  ...
  methods: {
    ...
    checkLayout() {
      let that = this;
      if (!this.$route.meta || !this.$route.meta.info) return;
