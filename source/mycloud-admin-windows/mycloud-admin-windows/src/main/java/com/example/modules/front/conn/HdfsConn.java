...
public class HdfsConn {
    ...
    private static final String serverUrl = "hdfs://127.0.0.1:9001/";
    // 改为你真实的安装路径，注意双斜杠
    private static final String HADOOP_HOME = "D:\\hadoop-3.3.6";
    ...
    private HdfsConn(){
        try {
            ...
            System.setProperty("HADOOP_USER_NAME", "xue");
